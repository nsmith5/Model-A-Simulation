...
public class Application : Gtk.Window
{
    ...
    public Application (int N)
    {
        ...
        vbox.pack_start (make_r_slider (), false, false, 4);
        vbox.pack_start (make_T_slider (), false, false, 4);
        this.add (vbox);
    ...
    private Gtk.Box make_r_slider()
    {
        ...
        r_slider.set_value_pos(PositionType.LEFT);
        ...
        r_box.pack_start (r_slider, true, true, 5);
        return r_box;
    }
